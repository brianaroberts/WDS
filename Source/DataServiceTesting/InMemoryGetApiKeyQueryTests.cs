...
{
    public class InMemoryGetApiKeyQueryTests
    {
        ...
        [Test]
        public void TestInMemoryGetApiKeyQuery()
        {
            try
            {
                WDS.Authentication.InMemoryGetApiKeyQuery keyQuery = new WDS.Authentication.InMemoryGetApiKeyQuery();
                keyQuery.Execute("ParkingPortal");
                Assert.Pass();
            }
            catch
            {
